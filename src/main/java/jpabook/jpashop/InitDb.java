...
public class InitDb {
    ...
    @PostConstruct
    public void init() {
        initService.dbInit1(); // Spring life cycle 때문에 PostConstruct 안에 Transactional을 넣는게 불가능하다. 따로 빼야ㅠ
        initService.dbInit2();
    }
    ...
    static class InitService {
        ...
        public void dbInit1() {
            Member member = createMember("userA", "서울", "강가", "00000");
            em.persist(member);
        ...
        public void dbInit2() {
            Member member = createMember("userB", "경기", "거리", "11111");
            em.persist(member);
